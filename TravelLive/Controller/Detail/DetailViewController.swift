...
extension DetailViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    @objc private func imageTapped(tapGestureRecognizer: UITapGestureRecognizer) {
        ...
        LottieAnimationManager.shared.setUplottieAnimation(name: "Hearts moving", excitTime: 4, view: self.view, ifPulling: false, ifBreak: false)
        // change heart button
    ...
    @objc private func clickLoveButton(_ sender: UIButton) {
        if sender.hasImage(named: "theheart", for: .normal) {
            ...
            LottieAnimationManager.shared.setUplottieAnimation(name: "Heart break", excitTime: 8, view: self.view, ifPulling: false, ifBreak: true)
