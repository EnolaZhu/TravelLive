...
class EventCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    func configureContentInset() {
        ...
        collectionView.contentInset = UIEdgeInsets.init(top: 100, left: inset, bottom: 0, right: inset)
    ...
    func resetContentInset() {
        ...
        collectionView.contentInset = UIEdgeInsets.init(top: 100, left: 0, bottom: 0, right: 0)
    }
}
